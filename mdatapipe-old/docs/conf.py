...
# -- Project information -----------------------------------------------------
prj_dist = pkg_resources.get_distribution('mdatapipe')
...
prj_py_min_supported = "2.7"
prj_py_max_supported = "3.6"
...
copyright = u'2018, ' + prj_author

rst_epilog = """
.. |project| replace:: {}
.. |min_py_supported| replace:: {}
.. |max_py_supported| replace:: {}
""".format(project, prj_py_min_supported, prj_py_max_supported)
...
htmlhelp_basename = 'mdatapipedoc'
...
latex_documents = [
    (master_doc, 'mdatapipe.tex', 'mdatapipe Documentation',
     u'João Pinto', 'manual'),
]
...
man_pages = [
    (master_doc, 'mdatapipe', 'mdatapipe Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mdatapipe', 'mdatapipe Documentation',
     author, 'mdatapipe', 'One line description of project.',
     'Miscellaneous'),
]
